...
export default function checkout() {
    ...
    const [pageLoading, setPageLoaing] = useState(true)
    ...
    <ScrollView className="flex-1 px-4 mt-4">
        ...
        {selectedAddress ? (
            <View className='bg-white p-3 rounded-xl mb-6 shadow-sm'>
                ...
                <TouchableOpacity onPress={()=> router.push('/addresses')} 
                className="bg-white border-dashed border-2 rounded-xl p-6 items-center 
                justify-center border-gray-100">
                    <Text className="text-primay font-bold">
                        Add Address
                    </Text>
                </TouchableOpacity>
                )}
                ...
                className={`bg-white p-4 rounded-xl mb-4
                    ...
                    <View className='ml-3 flex-1'>
                        ...
                        <Text className='text-secondary text-xs mt-1'>Pay when you receive your order</Text>
                    </View>
