    ...
    contentContainerStyle={!user ? {flex: 1, justifyContent: "center", alignItems: "center"} : {paddingTop: 16}}>
      {!user ? (
        ...
        <View className='items-center w-full'>
          ...
          <TouchableOpacity 
          onPress={()=>router.push('/sign-in')} className='bg-primary w-3/5 py-3 rounded-full
        ...
        <>
         ...
         <View className="items-center mb-8">
          ...
          <Text className="text-xl font-bold text-primary">{user.emailAddresses[0].emailAddress}</Text>
