  ...
  return (
   <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
    ...
    <View className='flex-row gap-2 mb-3 mx-4 my-2'>
        {/* Search bar*/}
        <View className='flex-1 flex-row items-center bg-white rounded-x1 border border-gray-100'>
            <Ionicons name='search' className="ml-4" size={20}
            color={COLORS.secondary}/>
            <TextInput className='flex-1 ml-2 text-primary px-4 py-3'
            placeholder='Search products...' returnKeyType='search' placeholderTextColor={COLORS.secondary}/>
        </View>
        {/* Filter icon*/}
        <TouchableOpacity>
